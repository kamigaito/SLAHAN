...
#ifndef INCLUDE_GUARD_LEARNER_BASE_HPP
#define INCLUDE_GUARD_LEARNER_BASE_HPP

namespace s2s {

class base_learner : public learner<encoder_decoder_base> {

public:

    base_learner(dynet::ParameterCollection& model, const s2s_options& opts, std::unique_ptr<encoder_decoder_base>& encdec) : learner(model, opts, encdec) {}
