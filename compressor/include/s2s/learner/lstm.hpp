...
#ifndef INCLUDE_GUARD_LEARNER_LSTM_HPP
#define INCLUDE_GUARD_LEARNER_LSTM_HPP

namespace s2s {

class lstm_learner : public learner<encoder_decoder_lstm> {

public:

    lstm_learner(dynet::ParameterCollection& model, const s2s_options& opts, std::unique_ptr<encoder_decoder_lstm>& encdec) : learner(model, opts, encdec) {}
